...
#ifndef PLAYWIRE_NONCOPPA_SWIFT_H
#define PLAYWIRE_NONCOPPA_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Playwire_NonCOPPA",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC17Playwire_NonCOPPA7PWC_PBD")
@interface PWC_PBD : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull EVT_prebidRequestSuccess;)
+ (NSString * _Nonnull)EVT_prebidRequestSuccess SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull EVT_prebidRequestSuccess_response;)
+ (NSString * _Nonnull)EVT_prebidRequestSuccess_response SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull EVT_prebidRequestSuccess_timestamp;)
+ (NSString * _Nonnull)EVT_prebidRequestSuccess_timestamp SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull EVT_prebidRequestSuccess_duration;)
+ (NSString * _Nonnull)EVT_prebidRequestSuccess_duration SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull EVT_prebidRequestFail;)
+ (NSString * _Nonnull)EVT_prebidRequestFail SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull EVT_prebidRequestFail_error;)
+ (NSString * _Nonnull)EVT_prebidRequestFail_error SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull EVT_prebidRequestFail_timestamp;)
+ (NSString * _Nonnull)EVT_prebidRequestFail_timestamp SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull EVT_prebidRequestFail_duration;)
+ (NSString * _Nonnull)EVT_prebidRequestFail_duration SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC17Playwire_NonCOPPA15Playwire_Amazon")
...
SWIFT_CLASS("_TtC17Playwire_NonCOPPA13Playwire_Meta")
...
SWIFT_CLASS("_TtC17Playwire_NonCOPPA18Playwire_Mintegral")
@interface Playwire_Mintegral : NSObject <PWAdNetworkRegistrable>
+ (void)register;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
