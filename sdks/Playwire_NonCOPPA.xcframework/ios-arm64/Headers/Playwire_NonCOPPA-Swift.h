...
SWIFT_CLASS("_TtC17Playwire_NonCOPPA19Playwire_Chartboost")
...
SWIFT_CLASS("_TtC17Playwire_NonCOPPA15Playwire_InMobi")
@interface Playwire_InMobi : NSObject <PWAdNetworkRegistrable>
+ (void)register;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC17Playwire_NonCOPPA19Playwire_IronSource")
...
SWIFT_CLASS("_TtC17Playwire_NonCOPPA14Playwire_Unity")
@interface Playwire_Unity : NSObject <PWAdNetworkRegistrable>
+ (void)register;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC17Playwire_NonCOPPA15Playwire_Vungle")
