...
- (void)setup;
- (void)clearExistingManualConsent;
- (void)configureCoppa;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull EVT_gamInit_error;)
+ (NSString * _Nonnull)EVT_gamInit_error SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull EVT_gamInit_error_dontmatch;)
+ (NSString * _Nonnull)EVT_gamInit_error_dontmatch SWIFT_WARN_UNUSED_RESULT;
...
+ (NSString * _Nonnull)EVT_CTX_configTargeting SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull EVT_CTX_loadTargeting;)
+ (NSString * _Nonnull)EVT_CTX_loadTargeting SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull EVT_CTX_globalTargeting;)
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull EVT_adImpression_timestamp;)
+ (NSString * _Nonnull)EVT_adImpression_timestamp SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull PWAdNetworkParam_GAMAdRequest;)
+ (NSString * _Nonnull)PWAdNetworkParam_GAMAdRequest SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@class PWRampConfig_Settings;
@class PWRampConfig_AdUnit;

SWIFT_CLASS("_TtC8Playwire12PWRampConfig")
@interface PWRampConfig : NSObject
@property (nonatomic, readonly, strong) PWRampConfig_Settings * _Nonnull settings;
@property (nonatomic, readonly, copy) NSArray<PWRampConfig_AdUnit *> * _Nonnull adUnits;
@end


SWIFT_CLASS("_TtC8Playwire25PWRampConfigAdUnitRefresh")
@interface PWRampConfigAdUnitRefresh : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC8Playwire19PWRampConfig_AdUnit")
@interface PWRampConfig_AdUnit : NSObject
@end


SWIFT_CLASS("_TtC8Playwire23PWRampConfig_AdUnit_Bid")
@interface PWRampConfig_AdUnit_Bid : NSObject
@end


SWIFT_CLASS("_TtC8Playwire30PWRampConfig_AdUnit_Bid_Params")
@interface PWRampConfig_AdUnit_Bid_Params : NSObject
@end


SWIFT_CLASS("_TtC8Playwire19PWRampConfig_Bidder")
@interface PWRampConfig_Bidder : NSObject
@end


SWIFT_CLASS("_TtC8Playwire21PWRampConfig_Settings")
@interface PWRampConfig_Settings : NSObject
@end
